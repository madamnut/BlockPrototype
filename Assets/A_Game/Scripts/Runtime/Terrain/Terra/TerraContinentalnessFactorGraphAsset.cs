...
[CreateAssetMenu(fileName = "TerraContinentalnessFactorGraph", menuName = "World/Terra/Continentalness Factor Graph")]
public sealed class TerraContinentalnessFactorGraphAsset : ScriptableObject
{
    ...
    public float EvaluateFactor(float continentalness)
    {
        ThrowIfInvalid();
        NormalizePoints();
