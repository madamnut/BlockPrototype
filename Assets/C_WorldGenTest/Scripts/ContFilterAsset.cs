...
[CreateAssetMenu(
    fileName = "ContFilter",
    menuName = "World/WorldGen/Cont Filter")]
public sealed class ContFilterAsset : ScriptableObject
{
    [System.Serializable]
    ...
    public float Evaluate(float cont)
    {
        return Mathf.Clamp(curve.Evaluate(cont), -1f, 1f);
    }
